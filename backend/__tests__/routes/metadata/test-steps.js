...
describe('POST /steps', () => {
    ...
    //         expect(res.status).toBe(200);
    //         expect(resContent.success).toBe(true);
    //         expect(omitDeep(resContent.result, '_id')).toStrictEqual(omitDeep(PUT_STEP_ADDED_FIELD_EXPECTED, '_id'));
    ...
    //         expect(res.status).toBe(200);
    //         expect(resContent.success).toBe(true);
    //         expect(omitDeep(resContent.result, '_id')).toStrictEqual(omitDeep(PUT_STEP_EDITED_FIELDS, '_id'));
